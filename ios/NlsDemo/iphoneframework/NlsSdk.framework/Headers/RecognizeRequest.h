...
#import "RecognizeRequestParam.h"
...
@interface RecognizeRequest: NSObject
@property(nonatomic,weak) id<NlsDelegate> delegate;

/**
 * @brief 设置RecognizeRequestParam对象参数
 */
-(void)setRecognizeParams:(RecognizeRequestParam *)requestParam;
